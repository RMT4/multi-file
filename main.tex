...
\newcommand{\SurnameAuthor}{Ciepliński}
...
\newcommand{\Supervisor}{$\langle$dr inż.$\rangle$}     % dane promotora (bez $\langle$ i $\rangle$)
\newcommand{\Title}{Kurs w ramach projetu FERS}           % tytuł pracy po polsku
\newcommand{\TitleAlt}{Course in the FERS project}                     % thesis title in English
...
\newcommand{\Consultant}{$\langle$dr$\rangle$} % dane promotora pomocniczego, opiekuna (bez $\langle$ i $\rangle$)
